...
|---|----------|-------------|--------|
| 01 | [Product Overview](01-product-overview.md) | Vision, target users, full feature list, monetization | Done |
| 02 | [MVP Scope](02-mvp-scope.md) | What's in/out for MVP, priority stack rank, definition of done | Done |
| 03 | [Roadmap](03-roadmap.md) | Phase plan with checklists (Phase 0–4) | Done |
...
| Date | Decision |
|------|----------|
| 2026-02-21 | MVP targets web + iOS simultaneously |
